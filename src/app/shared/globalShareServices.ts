...
export class globalShareServices {
  ...
  isGateway: boolean;
  isGatewayTemplate: boolean;
  gatewayTemplateNameInGatewayTemplatePage: any;
   ...
   gettingTemplate(template){
    ...
    setUploadTemplateObj(res){
        this.uploadTemplateObj=res;
    }
    ...
    setPreviousNodeIdentifier(nodeIdentifier: string) {
      ...
      setGatewayModelByTypeId(gatewayModelByGatewayTypeId){
          this.gatewayModelByGatewayTypeId=gatewayModelByGatewayTypeId;
      }
      setGatewayTemplateByTypeId(gatewayTemplateByGatewayTypeId){
          this.gatewayTemplateByGatewayTypeId=gatewayTemplateByGatewayTypeId;
      }
