...
export class globalSharedService {
    ...
    setGatewayAndTemplateRoutingPath(path): string {
        let gatewayAndTemplateRoutingPath;
        if (path[1] == "gateway-template") {
            return gatewayAndTemplateRoutingPath = "gateway-template";
        }
        else if (path[1] == "gateway") {
            return gatewayAndTemplateRoutingPath = "gateway";
        }
      }
